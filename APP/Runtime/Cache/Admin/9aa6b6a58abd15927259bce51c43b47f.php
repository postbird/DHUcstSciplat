...
</script><script type="text/javascript" src="__ROOT__/Data/Ueditor/ueditor.config.js"></script><script type="text/javascript" src="__ROOT__/Data/Ueditor/ueditor.all.min.js"></script></head><body style="padding:20px 20px 0px 20px"><h2 align="center">讲座列表</h2><hr/><div style="margin:10px 0;"></div><table id="dg" title="讲座列表" style="width:1080px;height:380px" ><?php if(is_array($lecture)): foreach($lecture as $key=>$u): ?><tr><td><?php echo ($u["lid"]); ?></td><td><?php echo ($u["ltitle"]); ?></td><td><?php echo ($u["llecturer"]); ?></td><td><?php echo ($u["ldate"]); ?></td><td><?php echo ($u["ldirector"]); ?></td><td><?php echo ($u["ldatestart"]); ?></td><td><?php echo ($u["ldateend"]); ?></td><td><?php if($u["lsheet"] == 1): ?>是
			<?php else: ?>
				否<?php endif; ?></td><td><a href="<?php echo U('Admin/Stu/lectureread',array('lid'=>$u['lid'],'unum'=>$unum,'uname'=>$uname));?>">报名</a><?php if($stusuper == 1): ?><a href="<?php echo U('Admin/Stu/mylectureread',array('lid'=>$u['lid'],'unum'=>$unum,'uname'=>$uname));?>">修改</a><a href="<?php echo U('Admin/Stu/mylectureapply',array('lid'=>$u['lid'],'unum'=>$unum,'uname'=>$uname));?>">查看报名</a><?php else: endif; ?></td></tr><?php endforeach; endif; ?></table><div style="padding-left:400px;"><?php echo ($page); ?></div><script>	$(function(){
