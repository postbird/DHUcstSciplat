...
</script><script type="text/javascript" src="__ROOT__/Data/Ueditor/ueditor.config.js"></script><script type="text/javascript" src="__ROOT__/Data/Ueditor/ueditor.all.min.js"></script></head><body style="padding:20px 20px 0px 20px"><h2 align="center">竞赛列表</h2><hr/><div style="margin:10px 0;"></div><table id="dg" title="竞赛列表" style="width:1080px;height:380px" ><?php if(is_array($race)): foreach($race as $key=>$u): ?><tr><td><?php echo ($u["rid"]); ?></td><td><?php echo ($u["rname"]); ?></td><td><?php echo ($u["rdatestart"]); ?></td><td><?php echo ($u["rdateend"]); ?></td><td><?php echo ($u["rsponsor"]); ?></td><td><?php echo ($u["rlevel"]); ?></td><td><a href="<?php echo U('Admin/Stu/raceread',array('rid'=>$u['rid'],'uname'=>$uname,'unum'=>$unum));?>">读取</a></td></tr><?php endforeach; endif; ?></table><div style="padding-left:400px;"><?php echo ($page); ?></div><script>	$(function(){
