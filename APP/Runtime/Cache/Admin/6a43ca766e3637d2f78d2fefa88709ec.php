	...
	<hr/>
	 <form id="form2" method='post' action="__URL__/updateselfmsghandle" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-3">
			      <input type="text" class="form-control" id="master" name="master" value='<?php echo ($user["master"]); ?>'  >
			    </div>
			    <label for="usernum" class="col-sm-2  control-label" >班级:</label>
			    <div class="col-sm-3">
			      <input type="text" class="form-control" id="grade" name="grade" value='<?php echo ($user["ugrade"]); ?>'  >
			    </div>
			</div>
			<div class="form-group">
