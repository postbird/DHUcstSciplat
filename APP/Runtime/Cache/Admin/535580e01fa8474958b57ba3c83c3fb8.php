        ...
        <!-- 角色判定 -->
		  <li>
			 <?php switch($us["rolename"]): case "学生": ?><li class="treeview">
				        ...
				        <li  class="treeview">
				        	<a href="http://cst.shiroimagnolia.com/accounts/userCheck?user=<?php echo ($userUrlNum); ?>&key=<?php echo ($userUrlName); ?>&code=<?php echo ($userUrlCheck); ?>">
					        	 <i class="fa fa-pie-chart"></i>
					             <span>兴趣小组</span>
					             <span class="pull-right-container">
					                <i class="fa fa-angle-left pull-right"></i>
				 ...
				 <?php case "科创管理员": ?><li class="treeview">
			        ...
			        <li class="treeview">
		           	...
		           	<li class="treeview">
				          ...
				          <ul class="treeview-menu">
				            <li><a href="<?php echo U('Admin/Stu/projectnews',array('uid'=>$us['uid'],'uname'=>$us['uname'],'unum'=>$us['unum']));?>" target="opt"><i class="fa fa-circle-o"></i>普通项目信息列表</a></li>
				          	<li><a href="<?php echo U('Admin/Stu/myproject',array('uid'=>$us['uid'],'uname'=>$us['uname'],'unum'=>$us['unum']));?>" target="opt"><i class="fa fa-circle-o"></i>我参加的项目</a></li>
				          </ul>
			        </li>
		           	<li class="treeview">
