...
</script><script type="text/javascript" src="__ROOT__/Data/Ueditor/ueditor.config.js"></script><script type="text/javascript" src="__ROOT__/Data/Ueditor/ueditor.all.min.js"></script></head><body style="padding:20px 20px 0px 20px"><h2 align="center">项目信息列表</h2><hr/><div style="margin:10px 0;"></div><table id="dg" title="项目信息列表" style="width:1080px;height:380px" ><?php if(is_array($projectnews)): foreach($projectnews as $key=>$u): ?><tr><td><?php echo ($u["pid"]); ?></td><td><?php echo ($u["ptitle"]); ?></td><td><?php echo ($u["pdatestart"]); ?></td><td><?php echo ($u["pdateend"]); ?></td><td><a href="<?php echo U('Admin/Stu/projectnewsread',array('pid'=>$u['pid'],'unum'=>$unum,'uname'=>$uname,'isleader'=>$u['isleader']));?>">查看</a><?php if($u['isleader'] == 1): ?>已担任队长
			<?php else: ?>
				&nbsp;<?php endif; ?></td></tr><?php endforeach; endif; ?></table><div style="padding-left:400px;"><?php echo ($page); ?></div><script>	$(function(){
