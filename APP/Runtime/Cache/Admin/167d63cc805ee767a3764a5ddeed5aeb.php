...
<style>
	.informtitle{text-align:center;}
	.inform{text-indent:3em;}
	.informdate{text-align:right;}
	.blue{color:blue;}
</style>
  </head>
	              ...
	              <div class="content " style="display: block;">
	             		<?php if($us['role'][0]['name'] == '学生'): ?><div id='sturace' style="display: block;>
							...
							<div id='stulec' style="display: block;>
		             			<label class="col-sm-2  control-label" >讲座:</label>
								<div class="col-sm-10 col-sm-offset-2">
									<label class="col-sm-3  control-label" >管理员审核未通过:</label>
									<div class="col-sm-9 col-sm-offset-2">
	             			...
	             			<div id='stupro' style="display: block;>
	                	...
	                	<?php if(($us['role'][0]['name'] == '高级管理员') or ($us['role'][0]['name'] == '科创管理员')): ?><div id='supmagpro' style="display: block;>
							...
							<div id='supmaglec' style="display: block;>
		             			<label class="col-sm-2  control-label" >讲座:</label>
								<div class="col-sm-10 col-sm-offset-2">
									<label class="col-sm-3  control-label" >管理员未审核:</label>
									<div class="col-sm-9 col-sm-offset-2">
	        ...
	        <div >
	          <div class="panel panel-default">
	              ...
	              <div class=" panel-body col-md-12" style="display: block;">
						<div class="col-md-6"><h4>邮箱</h4></div>
						<div class="col-md-6"><h4>jsjkczx@qq.com 【推荐】</h4></div>
						<div class="col-md-6"><h4>QQ群</h4></div>
						<div class="col-md-6"><h4>585410850【推荐】</h4></div>
						<div class="col-md-6"><h4>QQ</h4></div>
       ...
       <div >
          <div class="box">
			...
			<g id="seconds">
			  ...
			  <script src='__PUBLIC__/html5clock/js/snap.svg-min.js'></script>
			
			  <script src="__PUBLIC__/html5clock/js/index.js"></script>
