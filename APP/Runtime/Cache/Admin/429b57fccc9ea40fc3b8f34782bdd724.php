...
<body>
	<div class='container'>
		...
		<hr/>
	 	<?php if(is_array($elitegroup)): foreach($elitegroup as $i=>$v): ?><div class="col-md-12">
		 		<div class="col-sm-10">
		 				<label for="usernum" class="col-sm-3 " >分组<?php echo ($i+1); ?> : <?php echo ($v['ename']); ?></label>
					 	<div class="col-sm-9 ">
				 			<div class="col-sm-12">
				 				<br>
				 				<br>
				 			</div>
	 				 		<label for="usernum" class="col-sm-1 " >成员:</label>
							<div class="col-sm-11 ">
								<table class="table ">
									<?php if(is_array($v["elite"])): foreach($v["elite"] as $key=>$u): ?><tr>
								    		...
								    		<td>
								    			<a href="javascript:void(0)" onclick="deleteelite(<?php echo ($v['eid']); ?>,<?php echo ($u["uid"]); ?>)">&nbsp;删除</a>
								    		</td>
				...
				<div class="col-sm-2">
					<div style="text-align:right;width:95%;height:10em;">
			   			<a href="<?php echo U('Admin/SuperManage/addelite',array('eid'=>$v['eid'],'unum'=>$unum,'uname'=>$uname));?>">&nbsp;新增成员+&nbsp;&nbsp;&nbsp;</a>
			  			<a href="javascript:void(0)" onclick="deleteelitegroup(<?php echo ($v["eid"]); ?>)">&nbsp;<label style='color:red;'>[删除此分组]</label></a>
				   </div>
				</div>	
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <form id="form1" method='post' action="__URL__/addelitegroup" class="form-horizontal" enctype="multipart/form-data">
