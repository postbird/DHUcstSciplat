...
</script><script type="text/javascript" src="__ROOT__/Data/Ueditor/ueditor.config.js"></script><script type="text/javascript" src="__ROOT__/Data/Ueditor/ueditor.all.min.js"></script></head><body style="padding:20px 20px 0px 20px"><h2 align="center">我参加的讲座列表</h2><hr/><div style="margin:10px 0;"></div><table id="dg" title="讲座列表" style="width:1080px;height:380px" ><?php if(is_array($mylecture)): foreach($mylecture as $key=>$u): ?><tr><td><?php echo ($u["lecture_title"]); ?></td><td><?php if($u['lpresent'] == 0): ?>未参加
			<?php else: ?>
				已参加<?php endif; ?></td></tr><?php endforeach; endif; ?></table><div style="padding-left:400px;"><?php echo ($page); ?></div><script>	$(function(){
