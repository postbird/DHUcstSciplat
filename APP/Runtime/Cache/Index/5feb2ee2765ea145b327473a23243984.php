  ...
  /*.row{margin-right:-10px;margin-left:-15px}*/
...
</script><script type="text/javascript">    //需要的全局变量
   ...
   function logincheck(){
    ...
    function lectureapply(){
       var lid = arguments[0] ? arguments[0] : 0;
       var unum = arguments[1] ? arguments[1] : 0;
      if(lid==0 || unum==0){
        alert("请先登录");
        return ;
      }
	...
	li a{color:black;}
	li span{float:right;}
</style><div class='container content-top'><h3 class='head'><?php echo ($lecture['ltitle']); ?></h3><hr/><form id="form1" method='post'  class="form-horizontal" enctype="multipart/form-data"><div class="form-group"><div class="col-sm-2 info-box text-center ">描述:</div><div class="col-sm-10"><?php echo ($lecture['lcontent']); ?></div></div><hr><div class="form-group"><label  class="col-sm-2 text-center  primary-box" >限制人数:</label><label  class="col-sm-4  text-center " ><?php echo ($lecture['lnum']); ?></label><label  class="col-sm-2 text-center  danger-box" >已报名:</label><label  class="col-sm-4   text-center" ><?php echo ($usercount); ?></label></div><hr/><div class="form-group"><div class="col-sm-2 primary-box text-center">主讲人:</div><div  class="col-sm-6 text-center " ><h4><?php echo ($lecture['llecturer']); ?></h4></div></div><hr/><div class="form-group"><div class="col-sm-2 primary-box text-center">讲座时间:</div><label  class="col-sm-6 text-center" ><h4><?php echo ($lecture['ldate']); ?></h4></label></div><hr/><div class="form-group"><div class="col-sm-2 primary-box text-center">讲座地点:</div><label  class="col-sm-6  text-center" ><h4><?php echo ($lecture['lplace']); ?></h4></label></div><hr/><div class="form-group"><div class="col-sm-2 primary-box text-center">开始日期:</div><label  class="col-sm-4   text-center" ><h4><?php echo ($lecture['ldatestart']); ?></h4></label><div class="col-sm-2 danger-box text-center">截止日期:</div><label  class="col-sm-4   text-center" ><h4><?php echo ($lecture['ldateend']); ?></h4></label></div><hr/><div class="form-group"><div class="col-sm-2 primary-box text-center">负责人:</div><label  class="col-sm-4  text-center" ><h4><?php echo ($lecture['ldirectorname']); ?></h4></label><div class="col-sm-2 primary-box text-center">负责人电话:</div><label  class="col-sm-4  text-center" ><h4><?php echo ($lecture['ldirectortel']); ?></h4></label></div><hr/><div class="form-group"><div class="col-sm-2 danger-box text-center">是否有讲座单:</div><?php if($lecture['lsheet'] == 1): ?><label  class="col-sm-6  text-center" ><h4>是</h4></label><?php else: ?><label  class="col-sm-6 text-center" ><h4>否</h4></label><?php endif; ?></div><div class="modal-footer"><?php if( $user['unum'] == ''): ?><a class="btn btn-warning disabled" href="javascript:;" disabled>登陆后报名</a><?php elseif($isapply == 1): ?><a class="btn btn-warning disabled" href="javascript:;" disabled>已经报名</a><?php elseif($lecture['subtime'] == 1): ?><a class="btn btn-warning disabled" href="javascript:;" disabled>已经截止</a><?php elseif($userspill == 1): ?><a class="btn btn-danger disabled" href="javascript:;" disabled>人数已满</a><?php else: ?><a class="btn btn-success" href="javascript:;" onclick="lectureapply(<?php echo ($lecture["lid"]); ?>,<?php echo ($user['unum']); ?>)">报名</a><?php endif; ?><a class="btn btn-primary" href="<?php echo U('Index/Index/lecturelist');?>.html" target=""><span>返回</span></a></div></form></div><div class="container text-center" ><footer style="color:#cccccc;">©2016 Powered By 东华大学计算机科学与技术学院科技创新中心
