<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title><?php echo ($page_title); ?></title><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" type="text/css" href="__PUBLIC__/css/main.css"><link rel="stylesheet" href="__PUBLICFILE__/css/bootstrap.css"><link rel="stylesheet" href="__PUBLICFILE__/css/font-awesome.min.css"><link rel="stylesheet" href="__PUBLICFILE__/css/animate.min.css"><link rel="stylesheet" href="__PUBLICFILE__/css/all.css"><script src="__PUBLICFILE__/js/jquery.min.js"></script><script src="__PUBLICFILE__/js/bootstrap.min.js"></script><script src="__PUBLICFILE__/js/wow.min.js"></script><script src="__PUBLICFILE__/js/jquery.goup.min.js"></script><link rel="icon" href="__PUBLICFILE__/image/icon.png" sizes="32x32" /><style>	.loginfont{font-size:1.1em;}
  ...
  /*.row{margin-right:-10px;margin-left:-15px}*/
            ...
            </p><div class="col-md-12"><div class="col-sm-2"><label for="school"><h4>学院：</h4></label></div><div class="col-sm-8"><select name="school" id="school" class="form-control"><option value="计算机科学与技术学院">计算机科学与技术学院</option><option value="机械工程学院">机械工程学院</option><option value="信息科学与技术学院">信息科学与技术学院</option><option value="化学化工与生物工程学院">化学化工与生物工程学院</option><option value="材料科学与工程学院">材料科学与工程学院</option><option value="环境科学与工程学院">环境科学与工程学院</option><option value="纺织学院">纺织学院</option><option value="人文学院">人文学院</option><option value="理学院">理 学 院</option><option value="外语学院">外语学院</option><option value="马克思主义学院">马克思主义学院</option><option value="服装与艺术设计学院">服装与艺术设计学院</option><option value="旭日工商管理学院">旭日工商管理学院</option></select></div></div><div class="col-md-12"><div class="col-sm-2"><label for="unum"><h4>学号：</h4></label></div><div class="col-sm-4"><input type="text" class="form-control" name="unum" id="unum" placeholder="学号..." required="true"></div><div class="col-sm-2"><label for="uname"><h4>姓名：</h4></label></div><div class="col-sm-4"><input type="text" class="form-control" name="uname" id="uname" placeholder="姓名..." required="true"></div></div><div class="col-md-12"><div class="col-sm-2"><label for="master"><h4>专业：</h4></label></div><div class="col-sm-4"><select name="master" id="master" class="form-control"><option value="计算机类">计算机类</option><option value="软件工程">软件工程</option><option value="网络工程">网络工程</option><option value="计算机科学与技术">计算机科学与技术</option><option value="信息安全">信息安全</option></select></div><div class="col-sm-2"><label for="ugrade"><h4>班级：</h4></label></div><div class="col-sm-4"><input type="text" class="form-control" name="ugrade" id="ugrade" placeholder="如：计算机类1601" required="true"></div></div></div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">关闭</button><button type="submit" class="btn btn-primary">注册</button></div></form></div></div></div><!--注册modal 结束--><nav class="navbar navbar-inverse navbar-fixed-top" style="width:100%;background-color: #278DDE;border-color: #278DDE;border-radius: 0px;font-size:17px;"><div class="col-md-12 col-xs-12"style="background-color: #fff;"><div class="container" ><div class="col-md-6 col-xs-6"><h3 class="hidden-xs"><i class="fa fa-cubes"></i>   计算机科创中心管理平台</h3><h3 class="hidden-lg"><i class="fa fa-cubes"></i></h3></div><div class="col-md-6 col-xs-6"><div class=" text-right overflow-div"style="text-align:right;padding-top:20px;"><?php if($user != '' ): ?><h4 ><a href="<?php echo U('Admin/Index/index');?>"><i class="fa fa-user"></i>   用户:<?php echo ($user['uname']); ?>(<?php echo ($user['unum']); ?>)</a></h4><?php else: ?><h4 ><!-- <a href="<?php echo U('Admin/Login/index');?>"><i class="fa fa-user"></i>   登录</a> --><a  href="javascript:;"data-toggle="modal" data-target="#loginModal"><i class="fa fa-user"></i>   登录</a>                  &nbsp;|&nbsp;
                <a  href="javascript:;"data-toggle="modal" data-target="#registModal"><i class="fa fa-user-plus"></i>   注册</a></h4><?php endif; ?></div></div></div></div><div class="container-fluid"><!-- Brand and toggle get grouped for better mobile display --><div class="navbar-header"><button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button></div><!-- Collect the nav links, forms, and other content for toggling --><div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"><div class="container"><ul class="nav navbar-nav menu"><li class="nav-font"><a href="__ROOT__/" >首页 <span class="sr-only">(current)</span></a></li><li class="nav-font"><a href="<?php echo U('Index/Index/newslist');?>.html" target="">新闻</a></li><li class="nav-font"><a href="<?php echo U('Index/Index/lecturelist');?>.html" target="">讲座</a></li><li class="nav-font"><a href="<?php echo U('Index/Index/racelist');?>.html" target="">竞赛</a></li><li class="nav-font"><a href="<?php echo U('Index/Index/projectnewslist');?>.html" target="">项目</a></li><li class="nav-font"><a href="<?php echo U('Index/Index/elite');?>.html" target="">人才库</a></li><li class="nav-font"><a href="<?php echo U('Index/Index/about');?>.html" target="">关于</a></li><li class="nav-font"><a href="<?php echo U('Index/Index/suggest');?>.html" target="">反馈</a></li></ul></div><ul class="nav navbar-nav navbar-right menu"></ul></div><!-- /.navbar-collapse --></div><!-- /.container-fluid --></nav><div class="page-header"><div id="carousel-example-generic" class="carousel slide" data-ride="carousel"><!-- Indicators --><ol class="carousel-indicators"><!-- <li data-target="#carousel-example-generic" data-slide-to="0" class="active"></li> --><li data-target="#carousel-example-generic" data-slide-to="1"  class="active"></li></ol><!-- Wrapper for slides --><div class="carousel-inner" role="listbox"><div class="item active"><img src="__PUBLICFILE__/image/banner2.jpg" alt="cstkc-banner2"><div class="carousel-caption"><!-- 这里写文字  --></div></div></div><!-- Controls --><a class="left carousel-control" href="#carousel-example-generic" role="button" data-slide="prev"><span class=""><i class="fa fa-chevron-left" style="margin-top:80%;"></i></span><span class="sr-only">Previous</span></a><a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next"><span class=""><i class="fa fa-chevron-right" style="margin-top:80%;"></i></span><span class="sr-only">Next</span></a></div></div><div class="container" style="font-size:16px;"><div class="row"><div class="col-md-4"><div class="panel panel-primary panel_col panel-item-box"><div class="panel-heading menu-title"><i class="fa fa-newspaper-o"></i>&nbsp;&nbsp;新闻</div><?php if($newsFlag == 1): ?><ul class="list-group "><?php if(is_array($news)): foreach($news as $key=>$v): ?><li class="list-group-item"><a href="<?php echo U('Index/Index/news',array('view'=>$v['nid']));?>.html"><?php echo ($v["ntitle"]); ?></a><span><?php echo ($v["ndate"]); ?></span></li><?php endforeach; endif; ?></ul><ul class="text-right" style="padding-top:10px;padding-right:20px;"><a href="<?php echo U('Index/Index/newslist.html');?>" >更多>></a></ul><?php else: ?><h4 class="text-center red-font" style="padding-top:40px;"><i class="fa fa-warning"></i><br>暂无新闻
        </h4><?php endif; ?></div></div><div class="col-md-4"><div class="panel panel-primary panel_col panel-item-box"><div class="panel-heading menu-title"><i class="fa fa-qrcode"></i>&nbsp;&nbsp;讲座</div><?php if($lectureFlag == 1): ?><ul class="list-group"><?php if(is_array($lecture)): foreach($lecture as $key=>$v): ?><li class="list-group-item"><a href="<?php echo U('Index/Index/lecture',array('view'=>$v['lid']));?>.html"><?php echo ($v["ltitle"]); ?></a><span><?php echo ($v["ldatestart"]); ?></span></li><?php endforeach; endif; ?></ul><ul class="text-right" style="padding-top:10px;padding-right:20px;"><a href="<?php echo U('Index/Index/lecturelist');?>.html" >更多>></a></ul><?php else: ?><h4 class="text-center red-font" style="padding-top:40px;"><i class="fa fa-warning"></i><br>暂无讲座
        </h4><?php endif; ?></div></div><div class="col-md-4"><div class="panel panel-danger panel_col panel-item-box"><div class="panel-heading menu-title"><i class="fa fa-trophy"></i>&nbsp;&nbsp;科创达人榜 
        <span style="float:right;"><small><a href="<?php echo U('Index/Index/pointlist');?>.html" >更多>></a></small></span></div><?php if($userFlag == 1): ?><ul class="list-group"><?php if(is_array($stu)): foreach($stu as $key=>$v): ?><li class="list-group-item"><?php echo ($v["uname"]); ?><span><?php echo ($v["upoint"]); ?>分</span></li><?php endforeach; endif; ?></ul><?php else: ?><h4 class="text-center red-font" style="padding-top:40px;"><i class="fa fa-warning"></i><br>等你上榜
        </h4><?php endif; ?></div></div></div><hr/><div class="row"><div class="col-md-4"><div class="panel panel-info panel_col panel-item-box"><div class="panel-heading menu-title"><i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;竞赛</div><?php if($raceFlag == 1): ?><ul class="list-group"><?php if(is_array($race)): foreach($race as $key=>$v): ?><li class="list-group-item"><a href="<?php echo U('Index/Index/race',array('view'=>$v['rid']));?>.html"><?php echo ($v["rname"]); ?></a><span><?php echo ($v["rdatestart"]); ?></span></li><?php endforeach; endif; ?></ul><ul class="text-right" style="padding-top:10px;padding-right:20px;"><a href="<?php echo U('Index/Index/racelist');?>.html" >更多>></a></ul><?php else: ?><h4 class="text-center red-font" style="padding-top:40px;"><i class="fa fa-warning"></i><br>暂无信息
        </h4><?php endif; ?></div></div><div class="col-md-4"><div class="panel panel-info panel_col panel-item-box"><div class="panel-heading menu-title"><i class="fa fa-database"></i>&nbsp;&nbsp;项目</div><?php if($projectnewsFlag == 1): ?><ul class="list-group"><?php if(is_array($projectnews)): foreach($projectnews as $key=>$v): ?><li class="list-group-item"><a href="<?php echo U('Index/Index/projectnews',array('view'=>$v['pid']));?>.html"><?php echo ($v["ptitle"]); ?></a><span><?php echo ($v["pdatestart"]); ?></span></li><?php endforeach; endif; ?></ul><ul class="text-right" style="padding-top:10px;padding-right:20px;"><a href="<?php echo U('Index/Index/projectnewslist');?>.html">更多>></a></ul><?php else: ?><h4 class="text-center red-font" style="padding-top:40px;"><i class="fa fa-warning"></i><br>暂无信息
        </h4><?php endif; ?></div></div><div class="col-md-4"><div class="panel panel-info panel_col panel-item-box"><div class="panel-heading menu-title"><i class="fa fa-mortar-board"></i>&nbsp;&nbsp;人才库</div><?php if($eliteFlag == 1): ?><ul class="list-group"><?php if(is_array($elite)): foreach($elite as $key=>$v): ?><li class="list-group-item"><?php echo ($v["ename"]); ?></li><?php endforeach; endif; ?></ul><ul class="text-right" style="padding-top:10px;padding-right:20px;"><a href="<?php echo U('Index/Index/elite');?>.html" >详情>></a></ul><?php else: ?><h4 class="text-center red-font" style="padding-top:40px;"><i class="fa fa-warning"></i><br>暂无信息
        </h4><?php endif; ?></div></div></div></div><!--container--><div class="container text-center" ><footer style="color:#cccccc;">©2016 Powered By 东华大学计算机科学与技术学院科技创新中心
