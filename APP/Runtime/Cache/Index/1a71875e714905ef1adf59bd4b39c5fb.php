<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title><?php echo ($page_title); ?></title><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" type="text/css" href="__PUBLIC__/css/main.css"><link rel="stylesheet" href="__PUBLICFILE__/css/bootstrap.css"><link rel="stylesheet" href="__PUBLICFILE__/css/font-awesome.min.css"><link rel="stylesheet" href="__PUBLICFILE__/css/animate.min.css"><link rel="stylesheet" href="__PUBLICFILE__/css/all.css"><script src="__PUBLICFILE__/js/jquery.min.js"></script><script src="__PUBLICFILE__/js/bootstrap.min.js"></script><script src="__PUBLICFILE__/js/wow.min.js"></script><script src="__PUBLICFILE__/js/jquery.goup.min.js"></script><link rel="icon" href="__PUBLICFILE__/image/icon.png" sizes="32x32" /><style>	.loginfont{font-size:1.1em;}
  ...
  /*.row{margin-right:-10px;margin-left:-15px}*/
   ...
   function logincheck(){
	...
	.menu-title{font-size:1.1em;}
	li a{color:black;}
</style><div class='container content-top'><div class="panel panel-default"><div class="panel-heading"><h4>建议反馈</h4></div><div class="panel-body "><div class="well">					如果您有使用上的任何疑问或者建议,欢迎联系我们.我们将在最快时间给您答复.
				</div><div class="col-md-12"><div class="col-md-3"><h4>QQ群</h4></div><div class="col-md-6"><h4>585410850 【<span class="text-danger"><strong>推荐</strong></span>】</h4></div></div><div class="col-md-12"><div class="col-md-3"><h4>邮箱</h4></div><div class="col-md-6"><h4>jsjkczx@qq.com 【推荐】</h4></div></div><div class="col-md-12"><div class="col-md-3"><h4>QQ</h4></div><div class="col-md-6"><h4>jsjkczx@qq.com </h4></div></div></div></div><div class="panel panel-info"><div class="panel-heading"><h4>共同建设</h4></div><div class="panel-body "><div class="col-md-12"><h4>如果你对网站建设或者是科创中心感兴趣，欢迎加入我们 | <small>联系方式同上</small></h4><hr><h2><small>最基本的要求:</small></h2><h4 class="text-center">兴趣 & 坚持</h4></div></div></div></div><div class="container text-center" ><footer style="color:#cccccc;">©2016 Powered By 东华大学计算机科学与技术学院科技创新中心
