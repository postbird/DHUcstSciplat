	...
	<div class='container content-top'>
		<div class='page-header'>
	 	...
	 	<div class="list-group row">
			<?php if(is_array($stu)): $i = 0; $__LIST__ = $stu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="col-md-3">
 				 <li class="list-group-item" style="margin:4px;">【<?php echo ($i); ?>】<?php echo ($v["uname"]); ?><span><?php echo ($v["upoint"]); ?>分</span></li>
