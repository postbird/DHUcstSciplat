		...
		<hr/>
	 	<form id="form1" method='post'  class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<label  class="col-sm-4 text-center normalfont" ><?php echo ($projectnews['pdatestart']); ?></label>
					    <div class="col-sm-2 primary-box text-center">截止日期:</div>
					    <label  class="col-sm-4 normalfont text-center" ><?php echo ($projectnews['pdateend']); ?></label>
				    </div>
				    <hr/>
					<div class="form-group">
						<?php if($projectnews['paccessory'] == ''): else: ?>
					   		 <div class="col-sm-2 primary-box text-center">附件:</div>
					    	 <label  class="col-sm-10 text-center normalfont" ><a class="btn btn-default"href="<?php echo U('Index/Index/downfile');?>.html?back=.<?php echo ($projectnews['paccessory']); ?>"><i class="fa fa-download"></i>&nbsp;&nbsp;项目申请书下载</a></label><?php endif; ?>   
					</div>
					
			  		<div class="modal-footer">
		   			 	 <a class="btn btn-primary" href="<?php echo U('Index/Index/projectnewslist');?>.html" target=""><span>返回</span></a>
					</div>
		</form>
	</div>
