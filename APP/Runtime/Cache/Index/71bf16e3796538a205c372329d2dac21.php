<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title><?php echo ($page_title); ?></title><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" type="text/css" href="__PUBLIC__/css/main.css"><link rel="stylesheet" href="__PUBLICFILE__/css/bootstrap.css"><link rel="stylesheet" href="__PUBLICFILE__/css/font-awesome.min.css"><link rel="stylesheet" href="__PUBLICFILE__/css/animate.min.css"><link rel="stylesheet" href="__PUBLICFILE__/css/all.css"><script src="__PUBLICFILE__/js/jquery.min.js"></script><script src="__PUBLICFILE__/js/bootstrap.min.js"></script><script src="__PUBLICFILE__/js/wow.min.js"></script><script src="__PUBLICFILE__/js/jquery.goup.min.js"></script><link rel="icon" href="__PUBLICFILE__/image/icon.png" sizes="32x32" /><style>	.loginfont{font-size:1.1em;}
  ...
  .pagination .total-span a:hover{background-color:#fff;border:solid 1px #ccc;margin-right: 10px;}
	...
	.menu-title{font-size:1.1em;}
	li a{color:black;}
</style><div class='container content-top'><h3 class='head'><?php echo ($projectnews['ptitle']); ?></h3><hr/><form id="form1" method='post'  class="form-horizontal" enctype="multipart/form-data"><div class="form-group"><div class="col-sm-2 info-box text-center">描述 :</div><div class="col-sm-10 "><?php echo ($projectnews['pcontent']); ?></div></div><hr/><div class="form-group"><div class="col-sm-2 primary-box text-center">开始日期:</div><label  class="col-sm-4 text-center normalfont" ><?php echo ($projectnews['pdatestart']); ?></label><div class="col-sm-2 primary-box text-center">截止日期:</div><label  class="col-sm-4 normalfont text-center" ><?php echo ($projectnews['pdateend']); ?></label></div><hr/><div class="form-group"><?php if($projectnews['paccessory'] == ''): else: ?><div class="col-sm-2 primary-box text-center">附件:</div><label  class="col-sm-10 text-center normalfont" ><a class="btn btn-default"href="<?php echo U('Index/Index/downfile');?>.html?back=.<?php echo ($projectnews['paccessory']); ?>"><i class="fa fa-download"></i>&nbsp;&nbsp;项目申请书下载</a></label><?php endif; ?></div><div class="modal-footer"><a class="btn btn-primary" href="<?php echo U('Index/Index/projectnewslist');?>.html" target=""><span>返回</span></a></div></form></div><div class="container text-center" ><footer style="color:#cccccc;">©2016 Powered By 东华大学计算机科学与技术学院科技创新中心
