	 	...
	 	<form id="form1" method='post'  class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="form-group">
					    ...
					    <hr/>
					    	 ...
					    	 <label  class="col-sm-2 control-label normalfont" ><a href="<?php echo U('Index/Index/downfile');?>?back=.<?php echo ($news['naccessory']); ?>">附件下载</a></label><?php endif; ?>   
					</div>
					
			  		<div class="modal-footer">
		   			 	 <a class="btn btn-primary" href="<?php echo U('Index/Index/newslist');?>.html" ><span>返回</span></a>
					</div>
		</form>
	</div>
